...
- [Per-frame media encryption, explained: how to keep an SFU in the dark](/blog/per-frame-media-encryption-explained) — How per-frame encryption works with WebRTC Insertable Streams and SFrame.
- [End-to-end encrypted video conferencing: what it really means](/blog/end-to-end-encrypted-video-conferencing) — The architectural differences between hop-by-hop SRTP and zero-knowledge relays.
- [How to run a self-hosted video conferencing stack: a practical guide](/blog/run-a-self-hosted-video-conferencing-stack) — Step-by-step setup of signaling, SFUs, and Coturn relays.
- [OllaSync vs. Zoom vs. Microsoft Teams: High-Security Comparison](/blog/OllaSyncvsZoomvsMicrosoftTeams-High-Security-Self-Hosting-Comparison) — Architecture, E2EE, and self-hosting comparison.
