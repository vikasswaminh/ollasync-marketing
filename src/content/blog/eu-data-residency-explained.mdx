...
description: "Data residency, operator and jurisdiction are three different things — and confusing them is how an 'EU region' still ends up under foreign law. Here's what really gives you EU sovereignty."
pubDate: 2026-06-21
category: "Compliance"
...
"Our data is stored in an EU region." It sounds like a complete answer to data-sovereignty concerns. It usually isn't. The phrase quietly collapses three separate questions into one, and the gap between them is exactly where a lot of well-intentioned compliance work springs a leak.
...
For **hosted** use, Ollasync provides a DPA, with SCCs where any transfer genuinely applies, and states plainly where data is processed (application data in the United States, live media in Germany). We do not claim EU hosting for the managed service. For workloads where residency, operator and jurisdiction must all be yours, **self-hosting** puts them entirely under your control. We won't tell you that picking an EU region on someone else's cloud is the same thing as sovereignty — because it isn't, and pretending otherwise is how compliance programmes get surprised.
