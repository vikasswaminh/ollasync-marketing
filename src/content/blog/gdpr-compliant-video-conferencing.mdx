...
- For **hosted** use, Ollasync acts as a **processor**, offers a **DPA** and **SCCs** for any transfer that genuinely applies, and states where data is processed (application data in the United States, live media in Germany). We do not claim EU hosting for the managed service.
