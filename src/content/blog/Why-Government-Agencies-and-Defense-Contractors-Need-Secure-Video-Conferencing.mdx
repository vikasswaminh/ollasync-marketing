...
- **[Cryptography]** [How MLS encryption works (RFC 9420), explained simply](/blog/how-mls-encryption-works) — An accessible walkthrough of the IETF MLS standard behind server-blind group messaging: the ratchet tree, forward secrecy, and post-compromise security.
- **[Cryptography]** [Per-frame media encryption, explained: how to keep an SFU in the dark](/blog/per-frame-media-encryption-explained) — How per-frame media encryption uses WebRTC insertable streams and SFrame-style framing to hand a relay ciphertext it can route but never read.
- **[Compliance]** [Secure video conferencing for law firms: a confidentiality checklist](/blog/secure-video-conferencing-for-law-firms) — The same checklist approach applied to attorney-client privilege, for programs that also work with outside counsel.
